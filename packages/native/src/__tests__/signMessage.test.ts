...
describe("Sign message", () => {
    describe('EIP191', () => {
        ...
        test("sign basic 1", async () => {
            ...
            expect((signature as SignedMessageEIP191).signature).toBe("0xc26a3a1922d97e573db507e82cbace7b57e54106cc96d598d29ac16aabe48153313302cb629b7307baae0ae5e74f68e58564615ccfde0d03603381e1a233e0ed1c");
            expect((signature as SignedMessageEIP191).address).toBe("0x9d8A62f656a8d1615C1294fd71e9CFb3E4855A4F".toLowerCase())
        })
        ...
        test("sign basic 2", async () => {
            ...
            expect(signature).toBeDefined();
            expect(signature.type).toBe("eip191");
            expect((signature as SignedMessageEIP191).signature).toBe("0xde8d65f0d3de2fbdac8f9348b7e215bcaa7780f772ed28e7d6cdae458938b86b51411b1d50af102484b3bbd4cc1b8ace1ecbcd0747fbbf303d10beb579d67e4b1c");
            expect((signature as SignedMessageEIP191).address).toBe("0xF20b0DfCBBa3f62F3bCE61B2800Ff3Fb90A143b9".toLowerCase())
        })
