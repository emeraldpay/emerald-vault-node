...
let bitcoinEntry: BitcoinEntry = {
    address: undefined,
    addresses: [],
    blockchain: BlockchainId.BITCOIN,
    createdAt: undefined,
    id: "",
    key: undefined,
    xpub: []
...
describe("Types", () => {
    ...
    it("getAccountId", () => {
        expect(getAccountId({type: "hd-path", seedId: "test", hdPath: "m/44'/0'/0'/0/0"})).toBe(0);
        expect(getAccountId({type: "hd-path", seedId: "test", hdPath: "m/44'/60'/0'/0/0"})).toBe(0);
        expect(getAccountId({type: "hd-path", seedId: "test", hdPath: "m/44'/60'/1'/0/0"})).toBe(1);
        expect(getAccountId({type: "hd-path", seedId: "test", hdPath: "m/44'/60'/2'/0/0"})).toBe(2);
        expect(getAccountId({type: "hd-path", seedId: "test", hdPath: "m/44'/60'/15'/0/0"})).toBe(15);
    });
