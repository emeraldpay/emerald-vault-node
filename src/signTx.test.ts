...
describe("Sign transaction", () => {
    describe('Use vault 0.26', () => {
        ...
        test("sign", () => {
            ...
            let account = selectors.findAccount(wallet, "0x3eaf0b987b49c4d782ee134fdc1243fd0ccdfdd3");

            let raw = vault.signTx(wallet.id, account.id, tx, "testtest");
    ...
    describe('Import and sign', () => {
        ...
        test("sign with scrypt", () => {
            ...
            let raw = vault.signTx(walletId, accountId, tx, "sign with scrypt");
        ...
        test("sign with pbkdf2", () => {
            ...
            let raw = vault.signTx(walletId, accountId, tx, "testpassword");
        ...
        test("use mnemonic", () => {
            ...
            let raw = vault.signTx(walletId, accountId, tx, "1234");
